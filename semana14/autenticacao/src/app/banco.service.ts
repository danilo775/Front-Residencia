...
export class BancoService {
  ...
  apiURL = 'https://peca-320e4-default-rtdb.firebaseio.com/pecas.json';
  ...
  adicionarPeca(peca: {   nome: string,
    ...
    getPecas() {
      ...
      return this.http.get<{[key:string]: Peca}>('https://peca-320e4-default-rtdb.firebaseio.com/pecas.json').pipe(
        map( (responseData) => {
